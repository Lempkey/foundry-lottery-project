 ...
 * @notice This contract creates a sample raffle contract
...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    function performUpkeep(bytes calldata /* performData */) external {
        ...
        s_raffleState = RaffleState.CALCULATING; // Prevents reentrancy while picking a winner
    ...
    function fulfillRandomWords(
        ...
        s_recentWinner = recentWinner; // Cast winner
        s_raffleState = RaffleState.OPEN; // Reset raffle
